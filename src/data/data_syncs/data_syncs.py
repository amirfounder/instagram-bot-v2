...
def sync_responses(responses: list[dict]):
    ...
    for response in responses:
        ...
        save_datetime_to_synced_txt_file(response['x-metadata']['timestamp'])
...
def save_account_recommendations(response: dict):
    ...
    db_users = get_all_instagram_users_by_attr('ig_id', json_users_ig_ids)
...
def save_datetime_to_synced_txt_file(timestamp: str):
