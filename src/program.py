...
from src.data_manager.data import run_data_syncs
...
def run():
    ...
    state['console_client']['pid'] = spawn_process(run_console_client, (state,)).pid
    state['http_listener']['pid'] = spawn_process(run_http_listener, (state,)).pid
