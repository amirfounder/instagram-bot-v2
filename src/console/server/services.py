...
def start_instagram_agent_hashtag_research_program(seed_hashtag:str, state: dict[str, Any]):
    state['agent.is_running'] = True
    state['agent.tasks.research_hashtags.is_running'] = True
    state['agent.tasks.research_hashtags.seed_hashtag'] = seed_hashtag
